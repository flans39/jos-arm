...
CFLAGS += -fno-omit-frame-pointer
CFLAGS += -std=gnu99
CFLAGS += -Wall -Wno-format -Wno-unused -Werror -gstabs -mcpu=cortex-a7
...
QEMUOPTS = -kernel $(OBJDIR)/kern/kernel -cpu cortex-a7 -m 256 -M raspi2 -serial mon:stdio -gdb tcp::$(GDBPORT) -D qemu.log
